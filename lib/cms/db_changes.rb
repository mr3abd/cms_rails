  ...
  module DbChanges
    def self.latest_changes(limit = 1, min_date_time = nil, max_date_time = nil)
      ...
      changed_tables = tables_to_scan.map do |t|
        table_changes(t, column_name, limit, min_date_time, max_date_time)
    ...
    def self.table_changes(table_name, column_name, limit = 0, min_date_time = nil, max_date_time = nil)
      q = "select #{column_name} from #{table_name} ORDER BY #{column_name} desc"
